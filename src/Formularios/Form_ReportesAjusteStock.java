 ...
 */
package Formularios;
import Formularios.Form_FiltroVenta; 
...
public class Form_ReportesAjusteStock extends javax.swing.JInternalFrame implements InterfaceUsuario {
   private Connection conexion;
    private String reportePath;
    private String titulo;
    private HashMap<String, Object> parametros;

    public Form_ReportesAjusteStock(String reportePath, String titulo, Connection conexion, HashMap<String, Object> parametros) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setResizable(true);
        setTitle("Reportes de Ajuste Stock");
        ...
        jpReporte.setPreferredSize(new java.awt.Dimension(950, 500));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(jpReporte, javax.swing.GroupLayout.PREFERRED_SIZE, 408, Short.MAX_VALUE)
                .addContainerGap())
        );
...
public void generarReporte() {
    ...
    Form_FiltroAjuste dialogoFiltro = new Form_FiltroAjuste(frame, true, this);
