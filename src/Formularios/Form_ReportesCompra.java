...
public class Form_ReportesCompra extends javax.swing.JInternalFrame implements InterfaceUsuario {
   private Connection conexion;
    private String reportePath;
    private String titulo;
    private HashMap<String, Object> parametros;

    public Form_ReportesCompra(String reportePath, String titulo, Connection conexion, HashMap<String, Object> parametros) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jpReporte.setPreferredSize(new java.awt.Dimension(1050, 500));
...
public void generarReporte() {
    ...
    Form_FiltroCompra dialogoFiltro = new Form_FiltroCompra(frame, true, this);
