...
public class Form_FiltroCompra extends javax.swing.JDialog {
private DBTableController tr;
    private DBTableController tu;
    private Map<String, Object> filtrosMap;
    private HashMap<String, Object> parametros;
    private Form_ReportesCompra formReportes; // Agregar esta línea

    public Form_FiltroCompra(java.awt.Frame parent, boolean modal, Form_ReportesCompra formReportes) {
        super(parent, modal);
        initComponents();
...
public static void main(String args[]) {
    ...
    try {
        ...
        java.util.logging.Logger.getLogger(Form_FiltroCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    }
    //</editor-fold>
    //</editor-fold>
    //</editor-fold>
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
        public void run() {
            ...
            Form_FiltroCompra dialog = new Form_FiltroCompra(frame, true, null);  // Pasando null si no se necesita un callback para pruebas
