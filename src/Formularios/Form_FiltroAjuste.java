...
public class Form_FiltroAjuste extends javax.swing.JDialog {
private DBTableController tr;
    private DBTableController tu;
    private Map<String, Object> filtrosMap;
    private HashMap<String, Object> parametros;
    private Form_ReportesAjusteStock formReportes; // Agregar esta línea

    public Form_FiltroAjuste(java.awt.Frame parent, boolean modal, Form_ReportesAjusteStock formReportes) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        tr = new DBTableController();
        tr.iniciar("AJUSTES_STOCK");
...
public static void main(String args[]) {
    ...
    try {
        ...
        java.util.logging.Logger.getLogger(Form_FiltroAjuste.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    }
    //</editor-fold>
    //</editor-fold>
    //</editor-fold>
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
        public void run() {
            ...
            Form_FiltroAjuste dialog = new Form_FiltroAjuste(frame, true, null);  // Pasando null si no se necesita un callback para pruebas
