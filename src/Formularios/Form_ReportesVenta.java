...
public class Form_ReportesVenta extends javax.swing.JInternalFrame implements InterfaceUsuario {
   private Connection conexion;
    private String reportePath;
    private String titulo;
    private HashMap<String, Object> parametros;

    public Form_ReportesVenta(String reportePath, String titulo, Connection conexion, HashMap<String, Object> parametros) {
        initComponents();
...
public void generarReporte() {
    ...
    Form_FiltroVenta dialogoFiltro = new Form_FiltroVenta(frame, true, this);
